...
const links = [
    ...
    { text: "Analyze Survey Results ", href: "/admin/survey/analyze/", secondaryLink : ["/admin/survey/graphicalRepresentation/"] },
    { text: "Manage Surveys", href: "/admin/survey/manage/" },
  ];


export default function AdminSurveyNav():React.ReactNode {
